...
public class SalesControllerTests : IAsyncLifetime, IClassFixture<HttpClientFixture>
{
    ...
    private async Task<(HttpResponseMessage, ApiResponseWithData<SaleResult>)> Create<T>(T value)
    {
        var response = await _clientFixture.Client.PostAsJsonAsync("/api/sales", value);
    ...
    public async Task CreateSale_Expect_201_Created_On_Successful_Sale_Creation()
    {
        ...
        // Act
        var (response, apiResponse) = await Create(sale);
        ...
        Assert.Equal(sale.TotalAmount, apiResponse.Data.TotalAmount);
        Assert.Equal(sale.TotalItems, apiResponse.Data.TotalItems);
    }
    ...
    {
        // Act
        var response = await _clientFixture.Client.GetAsync("/api/sales");
    ...
    {
        // Act
        var response = await _clientFixture.Client.GetAsync("/api/sales?_page=2&_size=5");
    ...
    {
        // Act
        var response = await _clientFixture.Client.GetAsync("/api/sales?_order=price desc");
    ...
    public async Task ListSales_Expect_200_OK_And_Filtered_Results()
    {
        ...
        // Act
        var response = await _clientFixture.Client.GetAsync($"/api/sales?branch={filterValue}");
    ...
    public async Task ListSales_Expect_200_OK_And_Filtered_Results_Partial_Match()
    {
        ...
        // Act
        var response = await _clientFixture.Client.GetAsync($"/api/sales?branch={partialBranch}*");
    ...
    public async Task ListSales_Expect_200_OK_And_Results_Filtered_By_TotalAmount_Range()
    {
        ...
        // Act
        var response = await _clientFixture.Client.GetAsync($"/api/sales?_minTotalAmount={minTotalAmount}&_maxTotalAmount={maxTotalAmount}");
    ...
    {
        // Act
        var response1 = await _clientFixture.Client.GetAsync("/api/sales?_page=0");
        var response2 = await _clientFixture.Client.GetAsync("/api/sales?_size=0");
    ...
    public async Task ListSales_Expect_200_OK_And_Empty_List_When_No_Results_Match_Filter()
    {
        ...
        // Act
        var response = await _clientFixture.Client.GetAsync($"/api/sales?branch={nonExistentBranch}");
    ...
    public async Task ListSales_Expect_200_OK_And_Results_Ordered_By_Multiple_Fields()
    {
        ...
        // Act
        var response = await _clientFixture.Client.GetAsync("/api/sales?_order=price desc,name asc");
    ...
    public async Task CreateSale_Expect_400_Bad_Request_When_Branch_Is_Missing()
    {
        ...
        // Act
        var response = await _clientFixture.Client.PostAsJsonAsync("/api/sales", sale);
    ...
    public async Task GetSaleById_Expect_200_OK_On_Successful_Sale_Retrieval()
    {
        ...
        // Act
        var response = await _clientFixture.Client.GetAsync($"/api/sales/{sale.Id}");
    ...
    public async Task GetSaleById_Expect_404_Not_Found_When_Sale_ID_Does_Not_Exist()
    {
        ...
        // Act
        var response = await _clientFixture.Client.GetAsync($"/api/sales/{nonExistentId}");
    ...
    public async Task CancelSale_Expect_204_NoContent_On_Successful_Sale_Deletion()
    {
        // Arrange
        var sale = SaleTestData.Generate();
        var createResponse = await _clientFixture.Client.PostAsJsonAsync("/api/sales", sale);
        createResponse.EnsureSuccessStatusCode();
        var createdSale = await _clientFixture.DeserializeApiResponseWithData<SaleResult>(createResponse);

        // Act
        var response = await _clientFixture.Client.DeleteAsync($"/api/sales/{createdSale.Data.Id}");
    ...
    public async Task CancelSale_Expect_404_Not_Found_When_Sale_ID_Does_Not_Exist()
    {
        ...
        // Act
        var response = await _clientFixture.Client.DeleteAsync($"/api/sales/{nonExistentId}");
